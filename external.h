...
extern	LPCTSTR		RegTable2[][4];	// [iwad] Registry Entry List2
...
extern	TCHAR		szDefNameL[];	// [iwad] 左ソフトキー対応
extern	TCHAR		szOpenNameL[];	// [iwad] 左ソフトキー対応
extern	TCHAR		szDefNameR[];	// [iwad] 右ソフトキー対応
extern	TCHAR		szOpenNameR[];	// [iwad] 右ソフトキー対応
#ifndef	_WIN32_WCE
