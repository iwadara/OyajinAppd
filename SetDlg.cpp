...
//	[iwad] About Sheet
	...
	//iwad AboutÉAÉNÉVÉáÉìÇñ≥å¯Ç…Ç∑ÇÈv0.33
...
//	PageHeader.pszCaption = TEXT("Settings");
	PageHeader.pszCaption = TEXT("µÃﬂºÆ›ê›íË"); // by uminchu
...
//		SendDlgItemMessage(hDlg, IDC_SMALLFONT, CB_ADDSTRING, 0, (LPARAM )TEXT(" Auto"));
		SendDlgItemMessage(hDlg, IDC_SMALLFONT, CB_ADDSTRING, 0, (LPARAM )TEXT(" é©ìÆ"));	// by uminchu
...
//		SendDlgItemMessage(hDlg, IDC_MIDFONT, CB_ADDSTRING, 0, (LPARAM )TEXT(" Auto"));
		SendDlgItemMessage(hDlg, IDC_MIDFONT, CB_ADDSTRING, 0, (LPARAM )TEXT(" é©ìÆ"));		// by uminchu
...
//		SendDlgItemMessage(hDlg, IDC_BIGFONT, CB_ADDSTRING, 0, (LPARAM )TEXT(" Auto"));
		SendDlgItemMessage(hDlg, IDC_BIGFONT, CB_ADDSTRING, 0, (LPARAM )TEXT(" é©ìÆ"));		// by uminchu
		hDC = GetDC(hDlg);	// Get DC
